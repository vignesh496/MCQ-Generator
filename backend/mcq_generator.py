...
def generate_mcqs(prompt, n, difficulty):
    ...
    response = model.generate_content([
        ...
        "output: MCQs only from the given content, but not extra or out of the given content, either in sentence. Give MCQ as much as possible. I want only mcqs and no other comments. Each questions marked in serial numbers. Atl last, give with answers as options",
        "input: Python is a high level, scripting programming language. It is used to make AI/ML models.\n\n1 questions, easy level",
        "output: 1. What level of programming language is Python?\nOptions: [\"A. Low level\", \"B. High level\", \"C. Machine level\", \"D. Assembly level\"]\nRight Answer: B.",
